...
const route = {
  ...
  children: [
    ...
    {
      path: '/text2',
      meta: { title: 'text2', index: '1', icon: Minus },
      component: () => import('@/views/text/text2.vue')
    },
    {
      path: '/text3',
      meta: { title: 'text3', index: '2', icon: CirclePlus },
      component: () => import('@/views/text/text3.vue')
    },
    {
      path: '/text4',
      meta: { title: 'text4', index: '3', icon: Search },
      component: () => import('@/views/text/text4.vue')
    },
    {
      path: '/text5',
      meta: { title: 'text5', index: '4', icon: Female },
      component: () => import('@/views/text/text5.vue')
    },
    {
      path: '/text6',
      meta: { title: 'text6', index: '5', icon: Male },
      component: () => import('@/views/text/text6.vue')
    },
    {
      path: '/text7',
      meta: { title: 'text7', index: '6', icon: Aim },
      component: () => import('@/views/text/text6.vue')
    },
    {
      path: '/text8',
